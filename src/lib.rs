...
pub trait Filesystem {
    ...
    async fn copy_file_range(&self, _req: &Request, _ino_in: u64, _fh_in: u64, _offset_in: i64, _ino_out: u64,_fh_out: u64, _offset_out: i64,
        _len: u64, _flags: u32, reply: ReplyWrite,
    ) {
        reply.error(ENOSYS);
    }
